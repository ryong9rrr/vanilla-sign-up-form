const template = `
  <div id="field-{{id}}">
    <div class="mt-4">
      ...
      <input id="{{id}}" name="{{id}}" type="password" value="{{text}}" placeholder="{{placeholder}}" {{#if require}}required{{/if}} autocomplete="off" aria-label="Password" class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded">
      </div>
