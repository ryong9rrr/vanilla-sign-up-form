const template = `
  <div id="field-{{id}}">
    ...
    <div class="mt-2">
      <label class="mb-2 block text-sm" for="cus_email">{{label}}</label>
      <div class="flex items-center">
        <input id="address1" name="address1" type="text" value="{{displayAddress}}" placeholder="주소를 검색해 주세요" autocomplete="off" class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded">
